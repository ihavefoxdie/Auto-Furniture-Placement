namespace RoomClass
{
    static class Program
    {
        static void Main()
        {
            ...
            System.Console.WriteLine(furnitures[0].Vertices[0, 0] + " " + furnitures[0].Vertices[0, 1]);
            System.Console.WriteLine(furnitures[0].Vertices[1, 0] + " " + furnitures[0].Vertices[1, 1]);
            System.Console.WriteLine(furnitures[0].Vertices[2, 0] + " " + furnitures[0].Vertices[2, 1]);
            System.Console.WriteLine(furnitures[0].Vertices[3, 0] + " " + furnitures[0].Vertices[3, 1]);
            for (int i = 0; i < 1; i++)
                furnitures[0].Rotate(1);

            System.Console.WriteLine(furnitures[0].Rotation);
